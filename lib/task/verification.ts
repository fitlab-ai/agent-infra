...
const VERIFICATION_CATALOG: Readonly<Record<VerificationEvent, VerificationSpec>> = {
  ...
  'complete-task.preflight': { skill: 'complete-task', expectedState: 'active', mode: 'checks', checks: ['review-ledger', 'post-review-commit', 'required-checks', 'platform-sync-preflight'] },
