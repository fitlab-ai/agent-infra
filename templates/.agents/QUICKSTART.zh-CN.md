...
```bash
cp .agents/templates/task.zh-CN.md .ai-workspace/active/task-001.md
```
...
# 示例提示：
# "基于 .ai-workspace/active/task-001.md 中的分析结果，
...
# 示例提示：
# "实现 .ai-workspace/active/task-001.md 中描述的变更。
#  遵循设计部分。为此工作创建新分支。"
```
...
```bash
# 快速缺陷修复工作流
cp .agents/templates/task.zh-CN.md .ai-workspace/active/bugfix-001.md
# 编辑任务，然后：
# 1. 使用 Claude Code 分析
...
```bash
cp .agents/templates/review-report.zh-CN.md .ai-workspace/active/review-pr-42.md
...
```bash
cp .agents/templates/task.zh-CN.md .ai-workspace/active/refactor-001.md
...
```bash
cp .agents/templates/handoff.zh-CN.md .ai-workspace/active/handoff-task-001-phase2.md
```
